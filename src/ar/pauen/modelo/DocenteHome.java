...
public class DocenteHome {
    ...
    public Docente merge(Docente detachedInstance) {
        ...
        try {
            Docente result = (Docente) sessionFactory.getCurrentSession()
    ...
    public List<Docente> findByExample(Docente instance) {
        ...
        try {
            List<Docente> results = (List<Docente>) sessionFactory.getCurrentSession()
                    .createCriteria("ar.pauen.modelo.Docente")
                    .add( create(instance) )
            .list();
