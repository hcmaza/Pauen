...
public class MateriaHome {
    ...
    public Materia merge(Materia detachedInstance) {
        ...
        try {
            Materia result = (Materia) sessionFactory.getCurrentSession()
    ...
    public Materia findById( java.lang.Integer id) {
        ...
        try {
            Materia instance = (Materia) sessionFactory.getCurrentSession()
                    .get("ar.pauen.modelo.Materia", id);
            if (instance==null) {
    ...
    public List<Materia> findByExample(Materia instance) {
        ...
        try {
            List<Materia> results = (List<Materia>) sessionFactory.getCurrentSession()
                    .createCriteria("ar.pauen.modelo.Materia")
                    .add( create(instance) )
            .list();
