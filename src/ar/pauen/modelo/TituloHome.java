...
public class TituloHome {
    ...
    public Titulo merge(Titulo detachedInstance) {
        ...
        try {
            Titulo result = (Titulo) sessionFactory.getCurrentSession()
    ...
    public List<Titulo> findByExample(Titulo instance) {
        log.debug("finding Titulo instance by example");
        try {
            List<Titulo> results = (List<Titulo>) sessionFactory.getCurrentSession()
                    .createCriteria("ar.pauen.modelo.Titulo")
                    .add( create(instance) )
            .list();
