...
public class PaisHome {
    ...
    public Pais merge(Pais detachedInstance) {
        ...
        try {
            Pais result = (Pais) sessionFactory.getCurrentSession()
    ...
    public Pais findById( java.lang.Integer id) {
        log.debug("getting Pais instance with id: " + id);
        try {
            Pais instance = (Pais) sessionFactory.getCurrentSession()
                    .get("ar.pauen.modelo.Pais", id);
            if (instance==null) {
    ...
    public List<Pais> findByExample(Pais instance) {
        ...
        try {
            List<Pais> results = (List<Pais>) sessionFactory.getCurrentSession()
                    .createCriteria("ar.pauen.modelo.Pais")
                    .add( create(instance) )
            .list();
