 ...
 * @see ar.pauen.modelo.Departamento
...
public class DepartamentoHome {
    ...
    public Departamento merge(Departamento detachedInstance) {
        ...
        try {
            Departamento result = (Departamento) sessionFactory.getCurrentSession()
    ...
    public Departamento findById( java.lang.Integer id) {
        ...
        try {
            Departamento instance = (Departamento) sessionFactory.getCurrentSession()
                    .get("ar.pauen.modelo.Departamento", id);
            if (instance==null) {
    ...
    public List<Departamento> findByExample(Departamento instance) {
        ...
        try {
            List<Departamento> results = (List<Departamento>) sessionFactory.getCurrentSession()
                    .createCriteria("ar.pauen.modelo.Departamento")
                    .add( create(instance) )
            .list();
